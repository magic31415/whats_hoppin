defmodule WhatsHoppinWeb.CategoryController do
  ...
  #   changeset = Beer.change_category(%Category{})
  #   render(conn, "new.html", changeset: changeset)
  # end

  # def create(conn, %{"category" => category_params}) do
  #   case Beer.create_category(category_params) do
  #     {:ok, category} ->
  #       conn
  ...
  #   case Beer.update_category(category, category_params) do
  #     {:ok, category} ->
  #       conn
  ...
  #   category = Beer.get_category!(id)
  #   {:ok, _category} = Beer.delete_category(category)
