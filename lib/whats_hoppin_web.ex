defmodule WhatsHoppinWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: WhatsHoppinWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/whats_hoppin_web/templates",
                        namespace: WhatsHoppinWeb
